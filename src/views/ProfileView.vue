<template>
  <div>
    <TitleContainer :msg="'Profile site - ' + author.fullName" />
...
import TitleContainer from "@/components/typography/TitleContainer.vue";
...
@Component({
  components: { TextBody1, TextHeader, AffiliationContainer, AvatarComponent, TitleContainer },
})
